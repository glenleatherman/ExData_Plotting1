...
plot(timeDate(paste(mysub$Date, mysub$Time), format = "%d/%m/%Y %H:%M:%S"), mysub$Global_active_power, type="l", xlab = "", ylab = "Global Active Power")
plot(timeDate(paste(mysub$Date, mysub$Time), format = "%d/%m/%Y %H:%M:%S"), mysub$Voltage, type="l", xlab = "datetime", ylab = "Voltage")
...
plot(timeDate(paste(mysub$Date, mysub$Time), format = "%d/%m/%Y %H:%M:%S"), mysub$Global_reactive_power, type="l", xlab = "datetime", ylab = "Global Reactive Power")
